---
title: "Binary Phase Shift Keying Modulation - GOES Satellite Hunt | Lets Hack It"
description: "Written by Lucas Teske on 19 February 2017 Part of GOES Satellite Hunt Project overview → Binary Phase Shift Keying Modulation First things first. We successfully acquired a LRIT signal from GOES. Our first step is to demodulate the baseband signal from a SDR like Airspy or RTLSDR and transform..."
...
![Blank black square with no visible content or details.](/assets/goes-satellite-hunt/bpsk.png)
...
![Three diagrams showing current-carrying loops with magnetic field direction indicators.](/assets/goes-satellite-hunt/constellation-diag.png)
