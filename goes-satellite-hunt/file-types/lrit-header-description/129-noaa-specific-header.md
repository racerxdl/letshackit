---
title: "NOAA Specific Header - GOES Satellite Hunt | Lets Hack It"
description: "Written by Lucas Teske on 19 February 2017 Part of GOES Satellite Hunt Project overview → NOAA Specific Header This header specifies some of NOAA specific stuff meaning it is only applicable for GOES Satellites. Name Type Description Signature string (4) \"NOAA\" Product ID uint16_t Product ID of the file..."
