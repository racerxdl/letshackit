---
title: "Running code in a PAX Credit Card Payment Machine (part1) | Lets Hack It"
description: "Explore reverse engineering a PAX credit card payment machine to run code via processor swap and bypass tamper protection."
image: "https://lucasteske.dev/assets/Running code in a PAX Credit Card Payment Machine/7383f9c5e7832856c90b25549fb08115_MD5.jpeg"
---

# Running code in a PAX Credit Card Payment Machine (part1)

 ![Running code in a PAX Credit Card Payment Machine (part1)](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/7383f9c5e7832856c90b25549fb08115_MD5.jpeg)Written by Lucas Teske   
on 5 September 2025
...
Mercado pago is a bit more expensive, but easier to buy since you can just go to their normal market place (Mercado Livre) which is like EBay and buy the machines (see [https://lista.mercadolivre.com.br/maquina-de-cart%C3%A3o#D[A:Maquina%20de%20Cart%C3%A3o]](https://lista.mercadolivre.com.br/maquina-de-cart%C3%A3o#D[A:Maquina%20de%20Cart%C3%A3o]) )
...
So either way, I would need to open the machine and identify stuff. Just for the reference, the machine was this one:

![White handheld device with numeric keypad and small screen on wooden surface](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/cb3d6416e80906d1e1a3cfa7c27ec46c_MD5.jpeg)
...
![White electronic device labeled "TEC TOY" with RFID symbol, model D177, and production info.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/942368afcd3a8b5c2f6280b0686279ad_MD5.jpeg)Removing the screws does not trigger the tamper protection, but removing the case does. In the picture below, you can see the case removed, and I highlighted two of the tamper detection points.

![Open device showing battery, circuit board, and internal components.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/9a88c682e238fdb16c61122c76c2e14c_MD5.jpeg)on the back side of the case, there is some carbon-rubber points that touch these tamper points in the PCB. It works exactly the same as video game consoles controller buttons, but in this case, they just ensure the “button is always pressed”.

![White plastic device casing with label D177-RF-B and date 2021-06-04(V06)](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/3744913eb7cc7b866b64eb363d6fbbe5_MD5.jpeg)

And for some reason, the machine decided to tell us which one of the tampers we triggered :)

![Black-and-white photo of a keypad phone with screen showing "Switch EXT2" and "Switch EXT3".](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/9b728a005ceb00f991633d8d6ece65ed_MD5.jpeg)Also this resets over boot, do if you bridge them, you can use it to identify the names of each tamper point hehe.
...
![Black-and-white close-up of a circular perforated component inside a device casing.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/4454b7008ef72e53db283abd4afafb86_MD5.jpeg)
...
![Green circuit board with cutout, labeled "EB-V01", switches, and logos.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/930418d0ee33dd3362d0ac27de43fa8e_MD5.jpeg)

Removing all the plastic stuff, we reach the main PCB: ![Open electronic device showing circuit board, battery, and internal components.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/1d47f48f4cf614dd72e26c37c839895c_MD5.jpeg)

There is lot of stuff, but the stuff that we care in the bottom. ![Close-up of circuit board with chips, connectors, and heat sink fins.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/e808d21c32ba0866a386d155077709e4_MD5.jpeg)
...
![Monochrome display showing repeated "Switch" text with EXT0 to EXT7 labels in a grid pattern.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/55e76a7d0d22410d56bada5afad18bd8_MD5.jpeg)
...
![MH190x Family Security Technology features: crypto engine, physical, algorithm, and full-chip active shielding protections.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/cf4f007fbd8b87c83cb0e4f3c3560cc7_MD5.jpeg)(see [https://www.megahuntmicro.com/en/index.php?catid=5](https://www.megahuntmicro.com/en/index.php?catid=5) )
...
So how did I test my assumptions? Well, I found _by a chance_ that there is a arduino like chinese board from LUAT that uses an SoC called AIR105, it seens boring, but some of my baidu search pointed out that AIR105 actually uses a MH1903S core. The AIR105 are also available in aliexpress very easily to buy: [https://s.click.aliexpress.com/e/\_oBLNTrc](https://s.click.aliexpress.com/e/_oBLNTrc)

![DIYTZT air105 development board with 640KB RAM, 4MB flash, 204MHz, camera, and Arduino compatibility](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/427a383619233fb72eef5161e05511e8_MD5.jpeg)

I bought a few, decaped one and guess what. it is indeed a MH1903S :D

![Yellow pixelated text "1903S" on a faded, speckled background with vertical lines.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/9138886ea831b06c18888099fd0e26a6_MD5.jpeg)As a reference, when I decaped one of t he SoC from the machine, the writing was 1903A: ![Faded yellow text "1903A" on a blue surface, partially obscured by dirt and wear.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/feb55758da95a7ecb62f02451c058606_MD5.jpeg)Also, remember when I said flash memory is glued over the main die? Here is a shot showing both of them (sorry, I didn’t made a focus stacking). Flash memory is the one out of focus in the right. Bound wires are dead because I used 78% Nitric Acid and they’re copper ones. ![Faint, blurry image with vertical lines and speckles; text "1903S" visible on left.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/551efee7006a314cf9d0b9257bb61edc_MD5.jpeg) ![Rectangular maroon plaque with two square sections mounted on beige wall above dark strip.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/4fd85cc5f052df9b22c267e7559b0af5_MD5.jpeg)So basically, we could assume they’re similar at least. Their datasheets also tell about the same thing (seems like the only different is actually flash + ram)
...
![Block diagram of SC300 system architecture with bus matrix, peripherals, and memory controllers.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/8cd0cc82e5b752464a0617442e0c765f_MD5.jpeg)
...
| --- | --- | --- |
| 0x4000\_0000-0x4000\_03FF | SSC | AHB |
| 0x4000\_0800-0x4000\_0BFF | DMA | AHB |
| 0x4000\_0C00-0x4000\_0FFF | USB | AHB |
| 0x4000\_1000-0x4000\_13FF | LCD | AHB |
| 0x4000\_8000-0x4000\_BFFF | OTP | AHB |
| 0x4006\_0000-0x4006\_FFFF | DCMI | AHB |
| 0x4008\_0000-0x4008\_FFFF | CACHE | AHB |
| 0x400A\_2000-0x400A\_2FFF | QSPI | AHB |
| 0x400A\_3000-0x400A\_3FFF | SPIM5 | AHB |
| 0x4001\_0000-0x4001\_0FFF | SCI0 | APB0 |
| 0x4001\_2000-0x4001\_2FFF | CRC | APB0 |
| 0x4001\_3000-0x4001\_3FFF | Timer0 | APB0 |
| 0x4001\_4000-0x4001\_4FFF | ADC | APB0 |
| 0x4001\_5000-0x4001\_5FFF | SCI2 | APB0 |
| 0x4001\_6000-0x4001\_6FFF | UART0 | APB0 |
| 0x4001\_7000-0x4001\_7FFF | UART1 | APB0 |
| 0x4001\_8000-0x4001\_8FFF | SPIM1 | APB0 |
| 0x4001\_9000-0x4001\_9FFF | SPIM2 | APB0 |
| 0x4001\_A000-0x4001\_AFFF | SPIM0 | APB0 |
| 0x4001\_B000-0x4001\_BFFF | SPIS0 | APB0 |
| 0x4001\_C000-0x4001\_CFFF | Watchdog | APB0 |
| 0x4001\_D000-0x4001\_DFFF | GPIO | APB0 |
| 0x4001\_E000-0x4001\_EFFF | TRNG | APB0 |
| 0x4001\_F000-0x4001\_FFFF | SYS\_CTRL | APB0 |
| 0x4002\_0000-0x4002\_FFFF | MSR | APB1 |
| 0x4003\_0000-0x4003\_7FFF | BPU | APB2 |
| 0x4004\_4000-0x4004\_4FFF | UART2 | APB3 |
| 0x4004\_5000-0x4004\_5FFF | UART3 | APB3 |
| 0x4004\_8000-0x4004\_8FFF | KEYBOARD | APB3 |
| 0x4004\_9000-0x4004\_9FFF | I2C0 | APB3 |

RAM is mapped in the usual place for most of these ARM Cortex chips. They’re based on 0x2000\_0000, and span up to the max size (640KB for MH1903S and 1MB for MH1903). The bit bands are also in the places we expected, being 0x2200\_0000 for the SRAM. There are also more devices there, that I didn’t wrote here. These will have their own article after I finish mapping it everything I can.
...
![QFN88_J chip on green PCB with labeled pins around its perimeter.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/bacf2a2ebe249871db70adb98d4fa2b7_MD5.jpeg)I usually like to mark vias as well, since these boards are multilayred and you probably will need it to fully follow the tracks:

![Close-up of PCB with labeled UART0_RX, UART0_TX, and PA2 pins highlighted in green.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/fdeaa9034f0f2a2217c7d55f05e2e6f4_MD5.jpeg)For example this TX/RX tracks passes through the front of the PCB as well (don’t mind the misalignment, not sure why the image currently is like that)

![Close-up of PCB with labeled pins: UART0_RX, UART0_TX, PA2-PA3, PB0-PB5, PD1-PD11.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/652fd1331e348c4861938eadf3f0a824_MD5.jpeg)After following it through, I reached 2 of the 5 test pads in the right corner of the backside of the PCB, which I also marked in inkscape. ![Close-up of green circuit board showing UART_RX and UART_TX labeled pads with connecting traces.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/985831c28a29ecc016e52f876980476a_MD5.jpeg)So now that I had the UART, I could use it to reprogram the machine after a CPU Swap. And for those who are wondering: this UART, application wise, is the same as the USB port and Bluetooth so no leaky stuff (usually) is there, but the same thing the mobile application acesses it. And if it does, you don’t actually need to open it, since Bluetooth / USB will leak it the same.
...
Sadly these MH1903 devices are pretty rare to buy outside mainland china. From time to time they appear in Aliexpress as well. Here is an affiliate link: [https://s.click.aliexpress.com/e/\_oBMot6n](https://s.click.aliexpress.com/e/_oBMot6n) although it might be dead when you check this out (since they’re pretty rare).

![MH1903 QFN-88 IC chip, black square with text, green background, labeled "original and genuine"](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/c94d5244a68733e5cfbec91c6f08f5f0_MD5.jpeg)
...
![Five black square integrated circuits labeled MH1903 QFN88 HS202T38M in a clear plastic case.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/edad8e809adbb209bf4eca20043fd1dd_MD5.jpeg)Few years ago I tried swapping the CPU in that machine without any success. So I thought the issue was that the variant I had wasnt the J but the same as AIR105 (which would sort of make sense) and that made me sad. But I decided to try swap one of the AIR105 for that one just to dump the bootloader (more bootloaders = more info)

![Close-up of a black circuit board with gold pins, central chip, and USB connector.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/8fabf3473c8ee086fdea127b537c4ef6_MD5.jpeg)
...
![Table showing pin definitions for MH1903S QFN88_J 10mm×10mm package.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/725ff8aa056e6d095a4ac1ea1882fa1a_MD5.jpeg)

![Table showing pin definitions for MH1903S QFN88 package, highlighting pin 3 as 5V to 3.3V LDO input.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/839cea0de243ff5cc485a19e6a0fb849_MD5.jpeg)One of the differences between the J and non J version, is that the **non J** version (in this case AIR105) had an internal 3.3V LDO. And checking the schematics of the AIR105 board, guess what? No regulator onboard, everything was powered from the LDO.

![3.3V regulator with 1uF capacitor, labeled pins CVCC, VDD33, VCC, and GND connection.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/87356f1a4622aa38a746dd5676123bf5_MD5.jpeg)
...
![UART level shifter circuit using CH330N chip with power, reset, and signal connections.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/fd96942840f9a3924a76e5d843ee88a2_MD5.jpeg)So that made me wonder: How was it resetting the board? By looking at the pin-out, there is no reset button. But looking at AIR105 board schematic, we see a interesting thing:

![Circuit diagram with transistors, resistors, capacitor, and voltage source.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/217023812ae3d8552e72a67306105efa_MD5.jpeg)

![VBAT33 pin connected to 2.1V regulator and 1uF capacitor.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/0c7f3862853471f760b69c71098168a4_MD5.jpeg)
...
![Table row 88 shows VBAT33 with note: battery power required, else chip won't work.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/7a75d13b7c4758f46f7c29717f7907cd_MD5.jpeg)For those (like me) which is very rusty in Chinese, the marked text says basically: Battery power supply, must be powered otherwise the chip cannot work.
...
![Close-up of green circuit board with solder pads, traces, and component mounting areas.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/ea6eb39aabf1f914c71bda9f6eb79907_MD5.jpeg)
...
![Terminal screen showing firmware upload process with memory writing stages and device reset.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/a4da09ed6fa71e3bd9b38a0097594756_MD5.jpeg)Now I could run code in the real machine!

![Close-up of electronic circuit board with wires, capacitor, and soldered components.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/3247c212e1baa37421f763ede653c022_MD5.jpeg)
...
![MHEmu emulator interface showing LCD, GPIO, control buttons, and emulator log with interrupt messages.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/e129a7f1554e79536be3ca8d71fe03d9_MD5.jpeg)
...
![Orange cartoon character with open mouth, text "CARALHO" across its face.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/67e6e21e4aca4b6c3ceeb47bf2b57530_MD5.jpeg)Gimp is also nice that it can export directly to a C header, sort of compressed with a macro to actually get each R,G,B pixel values. So it was pretty easy to convert it.
...
![LCD displays "CARALHO" with a red monster, GPIO grid with yellow dots, and control buttons with hex offset.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/947b71be153e6405b62909b62e93385d_MD5.jpeg)

## Result

![White phone with screen showing "CARALHO" logo, keypad, and Linux command background.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/23c966b8036e41fe19f78b38bfa8bf73_MD5.jpeg)
...
- [https://github.com/racerxdl/platformio-air105](https://github.com/racerxdl/platformio-air105) - PIO Platform for AIR105/MH1903
- [https://github.com/racerxdl/framework-megahunt](https://github.com/racerxdl/framework-megahunt) - PIO Framework for Megahunt devices
- [https://github.com/racerxdl/air105-uploader](https://github.com/racerxdl/air105-uploader) - Python script to upload using the boot rom
- [https://archive.org/details/mh-1903-s-v-1.5](https://archive.org/details/mh-1903-s-v-1.5) - Some useful MH1903 datasheets
- [https://github.com/racerxdl/d177-crasharalho](https://github.com/racerxdl/d177-crasharalho) - Crasharalho Source Code
- [https://github.com/racerxdl/megahunt-bootroms](https://github.com/racerxdl/megahunt-bootroms) - Megahunt Bootroms
- [https://github.com/racerxdl/mhdumper](https://github.com/racerxdl/mhdumper) - Megahunt ROM Dumper Tool
...
Lucas Teske. “Running code in a PAX Credit Card Payment Machine (part1).” _Lets Hack It_, 2025. [https://lucasteske.dev/2025/09/running-code-in-pax-machines](https://lucasteske.dev/2025/09/running-code-in-pax-machines).

### BibTeX

```
@misc{teske2025runningcodeinpaxmachines,
  author = {Lucas Teske},
