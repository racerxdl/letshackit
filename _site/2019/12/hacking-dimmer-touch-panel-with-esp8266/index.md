---
title: "Hacking Dimmer Touch Panel with ESP8266 | Lets Hack It"
description: "Reverse engineer a LED dimmer touch panel using ESP8266 and SPI. Read button states and slider values for Home Assistant integration."
image: "https://lucasteske.dev/assets/posts/medium/0_NB2IwKOMRoAK5Yr5.png"
---

# Hacking Dimmer Touch Panel with ESP8266

 ![Hacking Dimmer Touch Panel with ESP8266](/assets/posts/medium/0_NB2IwKOMRoAK5Yr5.png)Written by Lucas Teske   
on 29 December 2019
...
![Touch Panel Board](/assets/posts/medium/0_BfQNjC-bMZTMbOb2.jpeg)_Touch Panel Board_

![Dimmer Board](/assets/posts/medium/1_YBQrRwabzV7tWWh8xdWqxA.png)_Dimmer Board_
...
![WTC801SPI Controller](/assets/posts/medium/1_LOEEUiky7RU3Kr7xkSYvAw.png)_WTC801SPI Controller_
...
For now I ignored the _OUT\_FLAG_ pin, because I can just read it from the SPI bus. If I wanted to make a ultra low power setup, I could use this pin to wake up the ESP8266 from a deep sleep to process. The OUT\_FLAG is high whenever any touch is made.

![ESP8266 hooked to Touch Panel Board](/assets/posts/medium/1_T0OihHoVLzgkJNuqmTlzNA.png)_ESP8266 hooked to Touch Panel Board_
...
![Bit map of read byte](/assets/posts/medium/1_SRpVyCM4_6abh1GUW6JGwg.png)_Bit map of read byte_
...
By running this and pressing some buttons, I can check that if nothing is pressed, it returns \*11111111\_.
...
Now we have the slider information in percent and button presses by name. There are some more nice work you can do, but I did a small library that does everything for you in a event way: [https://github.com/racerxdl/wtc801](https://github.com/racerxdl/wtc801)
...
Lucas Teske. “Hacking Dimmer Touch Panel with ESP8266.” _Lets Hack It_, 2019. [https://lucasteske.dev/2019/12/hacking-dimmer-touch-panel-with-esp8266/](https://lucasteske.dev/2019/12/hacking-dimmer-touch-panel-with-esp8266/).

### BibTeX

```
@misc{teske2019hackingdimmertouchpanelwithesp8266,
  author = {Lucas Teske},
  title = {Hacking Dimmer Touch Panel with ESP8266},
  year = {2019},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/2019/12/hacking-dimmer-touch-panel-with-esp8266/}
}
```
