---
title: "GOES Satellite Hunt (Part 5 – File Assembler) | Lets Hack It"
description: "Learn to assemble GOES satellite LRIT files. This guide covers packet aggregation, header parsing, and decompressing modified RICE data."
image: "https://lucasteske.dev/wp-content/uploads/2016/11/3Zz7gvgh-624x568.jpg"
---

# GOES Satellite Hunt (Part 5 – File Assembler)

 ![GOES Satellite Hunt (Part 5 – File Assembler)](/wp-content/uploads/2016/11/3Zz7gvgh-624x568.jpg)Written by Lucas Teske   
on 7 November 2016
...
The LRIT File has several headers. The first one is from the transport layer that says what is the file number and what is the total decompressed size. I usually ignore this data because its only used for validation of the finished file. This header has 10 bytes.
 ...
 ![LRIT File](https://i.imgur.com/OPMwMQz.png)
...
[![GOES 13 Full Disk Image](https://i.imgur.com/3Zz7gvgl.jpg)](http://imgur.com/3Zz7gvg)

GOES 13 Full Disk Image

 ![Meteosat Small Fulldisk image](https://i.imgur.com/ZPt2udw.jpg)

Meteosat Small Fulldisk image

[![WEFAX messages](https://i.imgur.com/TYA4b1Xl.jpg)](http://imgur.com/TYA4b1X)
...
I would like to thank Trango (@usa\_satcom) for all the help with the problems I had with Viterbi and ReedSolomon parts, and all other guys on #hearsat that helped me to build this project. I hope you all liked this article, and stay tuned for more!
...
Lucas Teske. “GOES Satellite Hunt (Part 5 – File Assembler).” _Lets Hack It_, 2016. [https://lucasteske.dev/2016/11/goes-satellite-hunt-part-5-file-assembler/](https://lucasteske.dev/2016/11/goes-satellite-hunt-part-5-file-assembler/).

### BibTeX

```
@misc{teske2016goessatellitehuntpart5fileassembler,
  author = {Lucas Teske},
  title = {GOES Satellite Hunt (Part 5 – File Assembler)},
  year = {2016},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/2016/11/goes-satellite-hunt-part-5-file-assembler/}
}
```
