---
title: "New 2.2m dish from Embrasat! | Lets Hack It"
description: "Building a new 2.2m Embrasat dish for GOES-16 GRB reception. Learn about DVB-S2, signal improvements, and assembly."
image: "https://lucasteske.dev/wp-content/uploads/2016/12/20161214_192121-1-624x351.jpg"
---

# New 2.2m dish from Embrasat!

 ![New 2.2m dish from Embrasat!](/wp-content/uploads/2016/12/20161214_192121-1-624x351.jpg)Written by Lucas Teske   
on 16 December 2016
...
\<img class=”aligncenter size-large” src=”https://i.imgur.com/hdTwpZJ.png” width=”1280 /\>&nbsp; ![](https://i.imgur.com/zYn605K.png)

![](https://i.imgur.com/qr0HsIn.png)
...
So I did the waterproof isolation with some Silicon Rubber around the screws on the floor and lots of PU Foam below the base. We did the PU Foam and put the base and tight the screws fast enough so the PU Foam would expand with the base over it, forcing the PU Foam to fill all the possible holes that the Silicon Rubber didn’t. The pressure also made the Silicon Rubber to fill better the holes. We waited one day to everything be ready and made some tests with water (and also we got a storm). Everything looks good now (no leaks so far).
 ...
 ![](https://i.imgur.com/61HIsZT.jpg)

Bottom of the floor where the dish is fixed (the ceil).

 ![](https://i.imgur.com/UWh9pQB.jpg)
...
So the signal almost doubled (from 5.4dB SNR to 10dB SNR) and my lock is basically perfect now. Regarding the decoder errors:
 ...
 ![](https://i.imgur.com/zRtIjme.png)

1.9m dish OpenSatelliteProject LRIT Decoder

 ![](https://i.imgur.com/OCDSHfo.png)
...
Lucas Teske. “New 2.2m dish from Embrasat!” _Lets Hack It_, 2016. [https://lucasteske.dev/2016/12/new-2-2m-dish-from-embrasat/](https://lucasteske.dev/2016/12/new-2-2m-dish-from-embrasat/).

### BibTeX

```
@misc{teske2016new22mdishfromembrasat,
  author = {Lucas Teske},
  title = {New 2.2m dish from Embrasat!},
  year = {2016},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/2016/12/new-2-2m-dish-from-embrasat/}
}
```
