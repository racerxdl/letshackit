...
description: "Como dumper firmware STM32F0x protegido com Raspberry Pi Pico. Bypass da RDP e código C para extração de memória flash."
image: "https://lucasteske.dev/assets/posts/patreon/Pasted image 20230124035811.png"
---

# STM32F0x Protected Firmware Dumper

 ![STM32F0x Protected Firmware Dumper](/assets/posts/patreon/Pasted%20image%2020230124035811.png)Escrito por Lucas Teske   
em 16 Janeiro 2024
...
![Dump funcionando de bytes](/assets/posts/patreon/Pasted%20image%2020230124035820.png)_Uma imagem mostrando fluxos de dados DWORD do firmware STM32F0 sendo transmitidos em tempo real via porta serial do Raspberry Pi Pico, iluminando o terminal com linhas de código extraído._
...
Lucas Teske. “STM32F0x Protected Firmware Dumper.” _Lets Hack It_, 2024. [https://lucasteske.dev/pt/2024/01/stm32f0x-protected-firmware-dumper](https://lucasteske.dev/pt/2024/01/stm32f0x-protected-firmware-dumper).
