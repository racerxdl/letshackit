---
title: "Segment Identification Header - GOES Satellite Hunt | Lets Hack It"
description: "Escrito por Lucas Teske em 19 Fevereiro 2017 Parte de GOES Satellite Hunt Visão geral do projeto → Segment Identification Header This header is used in Images to identify a segmented image data. It will only be present in images that are segmented in several LRIT files (which is most..."
