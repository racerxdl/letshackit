...
description: "Escrito por Lucas Teske em 19 Fevereiro 2017 Parte de GOES Satellite Hunt Visão geral do projeto → NOAA Specific Header This header specifies some of NOAA specific stuff meaning it is only applicable for GOES Satellites. Name Type Description Signature string (4) \"NOAA\" Product ID uint16_t Product ID of..."
