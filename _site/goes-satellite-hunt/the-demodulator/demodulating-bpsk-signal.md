---
title: "Demodulating BPSK Signal - GOES Satellite Hunt | Lets Hack It"
description: "Written by Lucas Teske on 19 February 2017 Part of GOES Satellite Hunt Project overview → Demodulating BPSK Signal How to make the reverse process (a.k.a. demodulate the signal)? First we need to make sure that we have our carrier in the base band (a.k.a. center of our spectrum). You..."
...
![Mathematical expressions involving f, θ, and their derivatives displayed in a vertical arrangement.](/assets/goes-satellite-hunt/costas-loop.png)
