---
title: "STM32F0x Protected Firmware Dumper | Lets Hack It"
description: "A guide on dumping STM32F0 protected firmware using Raspberry Pi Pico and SWD glitching to bypass Read-Out Protection (RDP)."
image: "https://lucasteske.dev/assets/posts/patreon/Pasted image 20230124035811.png"
---

# STM32F0x Protected Firmware Dumper

 ![STM32F0x Protected Firmware Dumper](/assets/posts/patreon/Pasted%20image%2020230124035811.png)Written by Lucas Teske   
on 16 January 2024
...
![Working dump of bytes](/assets/posts/patreon/Pasted%20image%2020230124035820.png)_An image showcasing streams of DWORD data from the STM32F0 firmware being transmitted in real-time via the Raspberry Pi Pico’s serial port, illuminating the terminal with lines of extracted code._
...
Lucas Teske. “STM32F0x Protected Firmware Dumper.” _Lets Hack It_, 2024. [https://lucasteske.dev/2024/01/stm32f0x-protected-firmware-dumper](https://lucasteske.dev/2024/01/stm32f0x-protected-firmware-dumper).
...
@misc{teske2024stm32f0xprotectedfirmwaredumper,
  ...
  url = {https://lucasteske.dev/2024/01/stm32f0x-protected-firmware-dumper}
}
```
