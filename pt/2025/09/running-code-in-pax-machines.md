---
title: "Rodando código em uma máquina de cartão de crédito PAX (parte 1) | Lets Hack It"
description: "Rodando código em uma máquina de cartão de crédito PAX. Engenharia reversa, troca de CPU e análise de segurança de terminais de pagamento."
...
# Rodando código em uma máquina de cartão de crédito PAX (parte 1)
 ...
 ![Rodando código em uma máquina de cartão de crédito PAX (parte 1)](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/7383f9c5e7832856c90b25549fb08115_MD5.jpeg)Escrito por Lucas Teske   
em 5 Setembro 2025
...
![White electronic device labeled "TEC TOY" with RFID symbol, model D177, and production info.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/942368afcd3a8b5c2f6280b0686279ad_MD5.jpeg)
...
![Open device showing battery, circuit board, and internal components.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/9a88c682e238fdb16c61122c76c2e14c_MD5.jpeg)
...
![Black-and-white photo of a keypad phone with screen showing "Switch EXT2" and "Switch EXT3".](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/9b728a005ceb00f991633d8d6ece65ed_MD5.jpeg)
...
Removendo todo plástico e a PCB, chegamos a placa principal: ![Open electronic device showing circuit board, battery, and internal components.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/1d47f48f4cf614dd72e26c37c839895c_MD5.jpeg)

E temos muitas coisas aqui, mas as coisas que nos importam estão na parte de baixo.

![Close-up of circuit board with chips, connectors, and heat sink fins.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/e808d21c32ba0866a386d155077709e4_MD5.jpeg)
...
![Faded yellow text "1903A" on a blue surface, partially obscured by dirt and wear.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/feb55758da95a7ecb62f02451c058606_MD5.jpeg)
...
![Faint, blurry image with vertical lines and speckles; text "1903S" visible on left.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/551efee7006a314cf9d0b9257bb61edc_MD5.jpeg)

![Rectangular maroon plaque with two square sections mounted on beige wall above dark strip.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/4fd85cc5f052df9b22c267e7559b0af5_MD5.jpeg)
...
A RAM está mapeada no lugar esperado pra esses ARM Cortex. Começa em 0x2000\_0000 e vão até o tamanho máximo da RAM (640KB pro MH1903S e 1MB pro MH1903). As bit-bands também estão no lugar esperado, 0x2200\_0000 pra RAM. Também há mais devices que não estão listados acima, esses terão seu próprio artigo depois que eu terminar de mapear tudo.
...
![QFN88_J chip on green PCB with labeled pins around its perimeter.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/bacf2a2ebe249871db70adb98d4fa2b7_MD5.jpeg)

Eu também marco as vias, por que essas placas costumam ser multi-layer e você vai precisar de tudo pra seguir elas:

![Close-up of PCB with labeled UART0_RX, UART0_TX, and PA2 pins highlighted in green.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/fdeaa9034f0f2a2217c7d55f05e2e6f4_MD5.jpeg)
...
![Close-up of PCB with labeled pins: UART0_RX, UART0_TX, PA2-PA3, PB0-PB5, PD1-PD11.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/652fd1331e348c4861938eadf3f0a824_MD5.jpeg)
...
![Close-up of green circuit board showing UART_RX and UART_TX labeled pads with connecting traces.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/985831c28a29ecc016e52f876980476a_MD5.jpeg)
...
Infelizmente esses MH1903 são bem raros pra comprar fora da china continental. De tempos em tempos eles aparecem na Aliexpress. Aqui está um link [https://s.click.aliexpress.com/e/\_oBMot6n](https://s.click.aliexpress.com/e/_oBMot6n) embora ele provavelmente vai estar morto quando você estiver lendo isso.
...
![Five black square integrated circuits labeled MH1903 QFN88 HS202T38M in a clear plastic case.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/edad8e809adbb209bf4eca20043fd1dd_MD5.jpeg)
...
![Table showing pin definitions for MH1903S QFN88 package, highlighting pin 3 as 5V to 3.3V LDO input.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/839cea0de243ff5cc485a19e6a0fb849_MD5.jpeg)
...
![UART level shifter circuit using CH330N chip with power, reset, and signal connections.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/fd96942840f9a3924a76e5d843ee88a2_MD5.jpeg)
...
![Table row 88 shows VBAT33 with note: battery power required, else chip won't work.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/7a75d13b7c4758f46f7c29717f7907cd_MD5.jpeg)Pra aqueles (como eu) que estão enferrujados no Chines, o texto acima basicamente diz: Alimentação da bateria, precisa ser energizado caso contrario o chip não funciona.
...
![Terminal screen showing firmware upload process with memory writing stages and device reset.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/a4da09ed6fa71e3bd9b38a0097594756_MD5.jpeg)
...
![Orange cartoon character with open mouth, text "CARALHO" across its face.](/assets/Running%20code%20in%20a%20PAX%20Credit%20Card%20Payment%20Machine/67e6e21e4aca4b6c3ceeb47bf2b57530_MD5.jpeg)
...
- [https://archive.org/details/mh-1903-s-v-1.5](https://archive.org/details/mh-1903-s-v-1.5) - Some usefull MH1903 datasheets
...
Lucas Teske. “Rodando código em uma máquina de cartão de crédito PAX (parte 1).” _Lets Hack It_, 2025. [https://lucasteske.dev/pt/2025/09/running-code-in-pax-machines](https://lucasteske.dev/pt/2025/09/running-code-in-pax-machines).
