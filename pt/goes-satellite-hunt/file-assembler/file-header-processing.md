...
description: "Escrito por Lucas Teske em 19 Fevereiro 2017 Parte de GOES Satellite Hunt Visão geral do projeto → File Header Processing The LRIT File has several headers. The first one is from the transport layer that says what is the file number and what is the total decompressed size. i..."
...
More details about LRIT file headers are available in the [LRIT Header Description](/pt/goes-satellite-hunt/file-types/lrit-header-description/).
