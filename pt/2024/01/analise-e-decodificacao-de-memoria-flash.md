---
title: "Análise e Decodificação de Memória Flash NAND - Revelando a Dispersão ECC em Dispositivos Desconhecidos | Lets Hack It"
description: "Aprenda a analisar memórias NAND Flash e decodificar dados usando binwalk. Entenda a arquitetura ECC e realize hardware hacking em dispositivos como máquinas de cartão."
image: "https://lucasteske.dev/assets/posts/analise-e-decodificacao-flash/flash-cell-programmed.svg"
---

# Análise e Decodificação de Memória Flash NAND - Revelando a Dispersão ECC em Dispositivos Desconhecidos

 ![Análise e Decodificação de Memória Flash NAND - Revelando a Dispersão ECC em Dispositivos Desconhecidos](/assets/posts/analise-e-decodificacao-flash/flash-cell-programmed.svg)Escrito por Lucas Teske   
em 16 Janeiro 2024
...
![Célula de memória Flash](/assets/posts/analise-e-decodificacao-flash/flash-cell.svg)_Diagrama detalhado de uma célula NAND_
...
Durante a operação de gravação, uma tensão é imposta sobre o Control Gate, induzindo elétrons a atravessarem a barreira de óxido e se alojarem no Floating Gate. Assim que os elétrons alcançam o Floating Gate, eles permanecem lá, denotando um estado “gravado”. ![Processo de gravação em memória flash](/assets/posts/analise-e-decodificacao-flash/flash-write.svg)
...
![Estado programado de uma célula NAND](/assets/posts/analise-e-decodificacao-flash/flash-cell-programmed.svg)_Célula NAND no estado “gravado”_
...
![Estado apagado de uma célula NAND](/assets/posts/analise-e-decodificacao-flash/flash-cell-erased.svg)_Célula NAND no estado “apagado”_

## Arquitetura da Memória NAND

![Estrutura de Bloco NAND Block](/assets/posts/analise-e-decodificacao-flash/nand-block.svg)_Diagrama representando a organização de um bloco NAND_
...
![Memória Flash no programador universal RT809H pronto para leitura](/assets/posts/analise-e-decodificacao-flash/flash_memory.jpg)_Memória Flash no programador universal RT809H pronto para leitura_
...
![Entropia da Imagem Lida](/assets/posts/analise-e-decodificacao-flash/flash-entropy.svg)_Entropia da Imagem Lida_
...
![Logotipo corrompido da PAX](/assets/posts/analise-e-decodificacao-flash/pax-broken.jpg)_Logotipo corrompido da PAX_
...
![Blocos de 512 bytes](/assets/posts/analise-e-decodificacao-flash/block-analysis.jpg)_Blocos de 512 bytes_
...
![Coluna aparentemente trocada de lugar](/assets/posts/analise-e-decodificacao-flash/block-analysis-1.png)_Coluna aparentemente trocada de lugar_
...
![Trocando colunas identificadas de local](/assets/posts/analise-e-decodificacao-flash/block-analysis-3.png)_Trocando colunas identificadas de local_
...
Após todos os passos de análise e correção, conseguimos extrair o _bitmap_ e validar que todas as nossas hipóteses e métodos de análise estavam corretos: ![Logotipo "ajustado" da PAX](/assets/posts/analise-e-decodificacao-flash/pax-fixed.jpg)_Logotipo “ajustado” da PAX_
...
Lucas Teske. “Análise e Decodificação de Memória Flash NAND - Revelando a Dispersão ECC em Dispositivos Desconhecidos.” _Lets Hack It_, 2024. [https://lucasteske.dev/pt/2024/01/analise-e-decodificacao-de-memoria-flash](https://lucasteske.dev/pt/2024/01/analise-e-decodificacao-de-memoria-flash).
