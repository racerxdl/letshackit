---
title: "Conectando ao ShadowNode com o MeshChatX | Lets Hack It"
...
_A página **Interfaces** com a conexão ShadowLink habilitada._
...
_Os valores do **TCP Client** usados para o ShadowNode._
...
_A página **Relay Chat** com **Add a hub** e o hub ShadowLink TSK-0 conectado._
...
_Informe o hash atual do destino RRC na janela **Add a Relay Chat Hub**._
...
_Digite `teskeslab` e clique em **+** para entrar na sala._
...
_A sala `teskeslab` conectada no MeshChatX._
...
Mister Maluco. “Conectando ao ShadowNode com o MeshChatX.” _Lets Hack It_, 2026. [https://lucasteske.dev/pt/2026/08/connect-to-shadownode-with-meshchatx](https://lucasteske.dev/pt/2026/08/connect-to-shadownode-with-meshchatx).
...
@misc{maluco2026connecttoshadownodewithmeshchatx,
  ...
  url = {https://lucasteske.dev/pt/2026/08/connect-to-shadownode-with-meshchatx}
}
```
