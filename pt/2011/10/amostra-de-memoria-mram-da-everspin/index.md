---
title: "Amostra de Memória MRAM da Everspin | Lets Hack It"
description: "Testando a memória MRAM da Everspin no FPGA. Saiba como essa tecnologia não volátil promete revolucionar o boot instantâneo dos computadores."
...
De qualquer maneira, aqui ta uma foto da placa _feia_&nbsp;que fiz para fazer uma interface para ela. Irei no futuro brincar um pouco com ela. Lembrando que ela retem os dados em no mínimo 20 anos (o que é bastante, embora não pareça os cartões de memória de hoje retem por menos tempo).
...
Lucas Teske. “Amostra de Memória MRAM da Everspin.” _Lets Hack It_, 2011. [https://lucasteske.dev/pt/2011/10/amostra-de-memoria-mram-da-everspin/](https://lucasteske.dev/pt/2011/10/amostra-de-memoria-mram-da-everspin/).

### BibTeX

```
@misc{teske2011amostradememoriamramdaeverspin,
  author = {Lucas Teske},
  title = {Amostra de Memória MRAM da Everspin},
  year = {2011},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/pt/2011/10/amostra-de-memoria-mram-da-everspin/}
}
```
