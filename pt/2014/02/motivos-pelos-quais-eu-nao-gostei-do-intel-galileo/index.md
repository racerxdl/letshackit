---
title: "Motivos pelos quais eu não gostei do Intel Galileo | Lets Hack It"
description: "O autor critica o Intel Galileo por problemas de GPIO (I2C), falta de GPU e dificuldades com o Linux e BSP. Veja a análise completa."
...
Então enquanto compilava fui ler o FAQ e descobri a cagada final da Intel. Essa cagada é relativa a GPIO do Galileo:&nbsp;[https://communities.intel.com/message/207619](https://communities.intel.com/message/207619)
...
Lucas Teske. “Motivos pelos quais eu não gostei do Intel Galileo.” _Lets Hack It_, 2014. [https://lucasteske.dev/pt/2014/02/motivos-pelos-quais-eu-nao-gostei-do-intel-galileo/](https://lucasteske.dev/pt/2014/02/motivos-pelos-quais-eu-nao-gostei-do-intel-galileo/).

### BibTeX

```
@misc{teske2014motivospelosquaiseunaogosteidointelg,
  author = {Lucas Teske},
  title = {Motivos pelos quais eu não gostei do Intel Galileo},
  year = {2014},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/pt/2014/02/motivos-pelos-quais-eu-nao-gostei-do-intel-galileo/}
}
```
