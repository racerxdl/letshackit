---
title: "Reverse Engineering cheap chinese \"VRCAM\" protocol | Lets Hack It"
description: "Reverse engineer the cheap Chinese VRCAM protocol. Analyze the proprietary SOUP and LTCP XML communication, sniff traffic with Wireshark, and build a Python script to interact with the Anyka IP camera."
image: "https://lucasteske.dev/assets/posts/medium/0*5_jc2oOyiJRbfezD.jpg"
---

# Reverse Engineering cheap chinese "VRCAM" protocol

 ![Reverse Engineering cheap chinese](/assets/posts/medium/0*5_jc2oOyiJRbfezD.jpg)Written by Lucas Teske   
on 16 June 2019
...
![The main board](/assets/posts/medium/0*5TFe884bl2lS08Ug.jpg)_The main board_

![The secondary board](/assets/posts/medium/0*39EiCjbgxvq_Vwcn.jpg)_The secondary board_

The WiFi chip is a RTL8188, which is a nice USB Wireless adapter.

![RTL8188FTV](/assets/posts/medium/1*lnaX3dIFByoBYHJ8J8QzFg.png)_RTL8188FTV_
...
![Close-up of ANYKA AK9918EN080 chip on circuit board with date 2017.08.24](/assets/posts/medium/1*joj8o9rxsVzQpoXv_JFkBQ.png)
...
![Close-up of a circuit board with components, wires, and a black speaker attached.](/assets/posts/medium/1*Rna323ta1jYKck0-Uh37Cg.png)
...
![Terminal window showing SPI flash BIOS read/write operations and successful load messages.](/assets/posts/medium/1*9kFM1kpoIMg0LgDCAgRrYw.png)
...
![Huawei + Xiaomi + Amazon + Aliplay + Alibaba. WTH?](/assets/posts/medium/1*H_qbyxw2mc44mp356pGMhg.png)_Huawei + Xiaomi + Amazon + Aliplay + Alibaba. WTH?_
...
![Network packet capture showing IP addresses, protocols, and data lengths in a tabular format.](/assets/posts/medium/1*gEiM0kWk4c0elMc9GDRpYg.png)
...
It reports two transfers _udx and ltcp_. I have no idea what those two are, but LTCP specify a port in which we have some packets later. So to be easier, let’s change the wireshark filter a bit:
...
Lucas Teske. “Reverse Engineering cheap chinese "VRCAM" protocol.” _Lets Hack It_, 2019. [https://lucasteske.dev/2019/06/reverse-engineering-cheap-chinese-vrcam-protocol/](https://lucasteske.dev/2019/06/reverse-engineering-cheap-chinese-vrcam-protocol/).

### BibTeX

```
@misc{teske2019reverseengineeringcheapchinesevrcamp,
  author = {Lucas Teske},
  title = {Reverse Engineering cheap chinese "VRCAM" protocol},
  year = {2019},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/2019/06/reverse-engineering-cheap-chinese-vrcam-protocol/}
}
```
