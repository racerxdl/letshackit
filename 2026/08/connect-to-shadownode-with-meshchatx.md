---
title: "Connecting to ShadowNode with MeshChatX | Lets Hack It"
...
_The Interfaces page with the ShadowLink connection enabled._
...
_The TCP Client values used for ShadowNode._
...
_The Relay Chat page with **Add a hub** and the connected ShadowLink TSK-0 hub._
...
_Enter the current RRC hub destination hash in the Add a Relay Chat Hub dialog._
...
_Enter `teskeslab` and click **+** to join the room._
...
_The connected `teskeslab` room in MeshChatX._
...
Mister Maluco. “Connecting to ShadowNode with MeshChatX.” _Lets Hack It_, 2026. [https://lucasteske.dev/2026/08/connect-to-shadownode-with-meshchatx](https://lucasteske.dev/2026/08/connect-to-shadownode-with-meshchatx).

### BibTeX

```
@misc{maluco2026connecttoshadownodewithmeshchatx,
  author = {Mister Maluco},
  title = {Connecting to ShadowNode with MeshChatX},
  year = {2026},
  publisher = {Lets Hack It},
  url = {https://lucasteske.dev/2026/08/connect-to-shadownode-with-meshchatx}
}
```
